			...
			public void onClick(View v) {
				if (scanThread == null || !scanThread.isAlive()) {
					...
					Scan scan = new Scan(Utilities.getApplicationFolder(context,
							...
							etxtArguments.getText().toString(), 0, context, saveHistory);
	...
	protected void onResume() {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				{
					PipsError.log("Warning: handler received unexpected non-null Message.obj not instanceof String.");
				}
